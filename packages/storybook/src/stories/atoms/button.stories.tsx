...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'The default button with standard styling and medium size.\n\n```tsx\n<Button>Click me</Button>\n```',
      },
    },
  },
};
...
export const Sizes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Button component in different sizes for various use cases.\n\n```tsx\n<Button size="sm">Small</Button>\n<Button size="md">Medium</Button>\n<Button size="lg">Large</Button>\n```',
      },
    },
  },
};
...
export const AsChild: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Using the asChild prop to render the button as a different element while maintaining button styling.\n\n```tsx\n<Button asChild>\n  <a href="#" className="no-underline">\n    Link Button\n  </a>\n</Button>\n```',
      },
    },
  },
};
...
export const Playground: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive playground to test different button configurations. Use the controls below to experiment with various props.\n\n```tsx\n<Button\n  variant="default"\n  size="md"\n  disabled={false}\n  asChild={false}\n>\n  Interactive Button\n</Button>\n```',
      },
    },
  },
};